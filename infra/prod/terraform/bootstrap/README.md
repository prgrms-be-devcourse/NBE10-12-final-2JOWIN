...
| IAM 역할 | `2jo-gha-cost` | `environment:cost-guard` · 비용 조회 + 인스턴스 정지 |

> 비용 Deny 가드레일은 여기 없다. `modules/cost-guard` 가 `2jo-tf-apply` 에 붙인다.
...
| 6 | OIDC 생성됨 | `aws iam list-open-id-connect-providers` | GitHub 항목 존재 |
