...
> **v1 구현 한계** (v1.6.15) — 이달 성사·담당자별 실적·단계 전환율은 `SalesStatsQuery` 자리표시자라 "집계 준비 중"으로 표시한다(0 아님). 응답 대기 목록은 영업 담당자도 본인 담당 Deal로 실필터한다(#207).
