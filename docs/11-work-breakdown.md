...
| C | `DealCommand` (promoteToQuoteStage — 발송 시 자동 승급 Q-25 · reassignOpenDeals — 비활성화 시 진행 중 담당 Deal 이관, 옮긴 id 반환 MB-14) (v2.0.8) | C(quote), A |
