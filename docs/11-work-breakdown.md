...
| C | `SalesStatsQuery` (대시보드 집계 — DB-01~08) (v2.0.1) · **pipeline만 실구현**, monthlyWon·performance·conversions는 빈 값 자리표시자 (v2.0.11 — 주문 합계는 order 모듈, 전환율은 전이 이력 부재) | D |
