...
public interface ViewTokenQuery {        // B가 CU-14, notification이 NT-12에서 호출 (v2.0.13)
...
| D | `ViewTokenQuery` (existsForContact — CU-14 · **quoteIdOf** — NT-12 실패 알림 토큰→견적 되짚기 (v2.0.13)) | B, D |
