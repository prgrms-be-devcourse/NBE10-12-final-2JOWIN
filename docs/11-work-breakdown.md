...
| C | `QuoteQuery` (응답 대기·임박 후보 — NT-05·06, DB-03) (v2.0.1) · **originsByIds·quoteIdsByDeals** (주문의 견적 경유 조회·SC-04 범위, OD-08·09) (v2.0.10) · **QuoteSummary에 dealId·companyId** (호출자가 거르는 축) (v2.0.11) · **findExpiringUntil → `findExpiringBetween(from, to)`** — 전 회사·양 끝 포함, 대상은 SENT·VIEWED (v2.0.23, NT-06) | D, C(order) |
