...
| C | `DealCommand` (promoteToQuoteStage — 발송 시 자동 승급 Q-25 · reassignAll — 비활성화 시 담당 이관 MB-14) (v2.0.6) | C(quote), A |
