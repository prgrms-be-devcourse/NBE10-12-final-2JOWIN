...
| C | `DealQuery` (assigneeIdOf·isOpen·hasOpenDeals·summariesByCustomer·summariesByIds·assignedDealIds·customerIdOf) | B, D |
| C | `DealCommand` (promoteToQuoteStage — 발송 시 자동 승급 Q-25 · reassignAll — 비활성화 시 담당 이관 MB-14) (v2.0.7) | C(quote), A |
