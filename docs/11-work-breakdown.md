...
| C | `DealCommand` (promoteToQuoteStage — 발송 시 자동 승급 Q-25 · **markWon** — 주문 전환 시 자동 성사 OD-06 (v2.0.10) · reassignOpenDeals — 비활성화 시 진행 중 담당 Deal 이관, 옮긴 id 반환 MB-14 (v2.0.8)) · **셋 다 `MANDATORY`** — 호출자의 쓰기 트랜잭션 필수 (v2.0.21, #227) | C(quote·order), A |
